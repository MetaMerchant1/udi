...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-500 text-[#24363d] hover:bg-primary-400 focus:ring-primary-500 shadow-[0_8px_24px_-4px_rgba(244,194,11,0.4)] hover:shadow-[0_12px_32px_-4px_rgba(244,194,11,0.5)] hover:-translate-y-0.5 font-bold',
      ...
      outline: 'bg-white border-2 border-primary-500 text-primary-700 hover:bg-primary-50 focus:ring-primary-500 shadow-[0_8px_24px_-4px_rgba(244,194,11,0.2)] hover:shadow-[0_12px_32px_-4px_rgba(244,194,11,0.3)] hover:-translate-y-0.5',
    };
